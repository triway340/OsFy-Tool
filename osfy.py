...
def opcion1():
        while True:
                ...
                print(f"{BLUE}[ {PURPLE}5 {BLUE}] {RESET}- {CYAN}Social Fish")
                print(f"{BLUE}[ {PURPLE}X {BLUE}] {RESET}- {CYAN}Volver\n")
                time.sleep(1)
...
def contactos():
        while True:
                ...
                if c1=="1":
                        ...
                        time.sleep(1)
                        print(f"{GREEN}TikTok: {RESET}https://tiktok.com/@triwaytri")
                        time.sleep(1)
                        ...
                        time.sleep(1)
                        print(f"{GREEN}TikTok: {RESET}https://tiktok.com/@....foxy_0")
                        time.sleep(1)
